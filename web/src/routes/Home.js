    ...
    <Main>
      ...
      <FullPageBackground>
        <CenteredArea>
          <DoublePaddedArea>
            <PaddedArea>
              <Thesis center>The upcoming midterm elections will give graduating seniors the opportunity to make themselves heard</Thesis>
            </PaddedArea>
      ...
      <DoublePaddedArea>
        <CardLayout>
          <RegisterCard>
            <CardImage src="https://images.unsplash.com/photo-1534274072914-70a682ff32b9?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=6813cdbe9e5aca2f029d963332424a75&auto=format&fit=crop&w=2250&q=80" />
            <CardContent>
              <CardHeader>Register to vote</CardHeader>
              <CardCopy>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</CardCopy>
            </CardContent>
          </RegisterCard>
          <AmbassadorCard>
